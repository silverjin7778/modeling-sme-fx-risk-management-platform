...
│   ├── 📁 한국은행 통화정책 브리핑 요약  # 한국은행 브리핑 스크래핑 + API 연결 및 요약 코드
│   ├── 📁 환율변동성지수 개발           # EPU 지수 기반 환율 변동성 지표 개발
│   ├── 📁 환율예측_분류                 # 환율 상승/하락 분류 예측
│   └── 📁 환율예측_회귀_4개통화         # 원/달러, 원/위안, 원/엔, 원/유로 회귀 예측
│
├── 📁 image/                          # README 및 문서에 사용되는 이미지
│
├── 📄 README.md                       # 프로젝트 설명 문서
├── 📄 PPT.pdf                         # 최종 발표 자료
├── 📄 결과보고서.pdf                    # 프로젝트 최종 보고서
├── 📄 데이터명세서.xlsx                 # 데이터와 변수 설명
└── 🎬 시연영상.mp4                     # 개발한 플랫폼 시연 영상
