...
import joblib
joblib.dump(model_lstm, 'dollar_하루.pkl')
joblib.dump(scaler_X, 'dollar_scaler_X_하루.pkl')
joblib.dump(scaler_y, 'dollar_scaler_y_하루.pkl')
...
import joblib
joblib.dump(model_lstm, 'dollar_일주일.pkl')
joblib.dump(scaler_X, 'dollar_scaler_X_일주일.pkl')
joblib.dump(scaler_y, 'dollar_scaler_y_일주일.pkl')
...
import joblib
joblib.dump(model_lstm, 'dollar_한달.pkl')
joblib.dump(scaler_X, 'dollar_scaler_X_한달.pkl')
joblib.dump(scaler_y, 'dollar_scaler_y_한달.pkl')
...
import joblib
joblib.dump(model_lstm, 'dollar_세달.pkl')
joblib.dump(scaler_X, 'dollar_scaler_X_세달.pkl')
joblib.dump(scaler_y, 'dollar_scaler_y_세달.pkl')
